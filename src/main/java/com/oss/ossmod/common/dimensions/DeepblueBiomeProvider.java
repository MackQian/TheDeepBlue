...
// this class should have a method/variable containing biomes that we want to put in the dimension.
// currently this is a subclass of a netherbiomeprovider, but in the future we should probably
// change this to be a subclass of just a biomeprovider.
public class DeepblueBiomeProvider extends NetherBiomeProvider {

    public static final MapCodec<NetherBiomeProvider> PACKET_CODEC = RecordCodecBuilder.mapCodec(
            (instance) -> instance.group(
                    Codec.LONG.fieldOf("seed")
                            .orElseGet(1124151251512)//default value for now
    ...
    // this probably would get modified a bit to use our generated biome.
    private DeepblueBiomeProvider(long seed, List<Pair<Biome.Attributes, Supplier<Biome>>> biomeAttributes, Optional<Pair<Registry<Biome>, NetherBiomeProvider.Preset>> netherProviderPreset) {
